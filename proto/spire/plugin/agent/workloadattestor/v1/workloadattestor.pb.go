...
func (x *AttestRequest) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
const file_spire_plugin_agent_workloadattestor_v1_workloadattestor_proto_rawDesc = "" +
	"\n" +
	"=spire/plugin/agent/workloadattestor/v1/workloadattestor.proto\x12&spire.plugin.agent.workloadattestor.v1\"\xbf\x01\n" +
	"\rAttestRequest\x12\x10\n" +
	"\x03pid\x18\x01 \x01(\x05R\x03pid\x12_\n" +
	"\bmetadata\x18\x02 \x03(\v2C.spire.plugin.agent.workloadattestor.v1.AttestRequest.MetadataEntryR\bmetadata\x1a;\n" +
	...
	"\x06Attest\x125.spire.plugin.agent.workloadattestor.v1.AttestRequest\x1a6.spire.plugin.agent.workloadattestor.v1.AttestResponseBSZQgithub.com/accuknox/spire-plugin-sdk/proto/spire/plugin/agent/workloadattestor/v1b\x06proto3"
...
var file_spire_plugin_agent_workloadattestor_v1_workloadattestor_proto_goTypes = []any{
	...
	nil,                    // 2: spire.plugin.agent.workloadattestor.v1.AttestRequest.MetadataEntry
}
var file_spire_plugin_agent_workloadattestor_v1_workloadattestor_proto_depIdxs = []int32{
	2, // 0: spire.plugin.agent.workloadattestor.v1.AttestRequest.metadata:type_name -> spire.plugin.agent.workloadattestor.v1.AttestRequest.MetadataEntry
