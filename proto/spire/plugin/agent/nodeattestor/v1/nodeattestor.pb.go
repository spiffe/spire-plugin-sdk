...
const file_spire_plugin_agent_nodeattestor_v1_nodeattestor_proto_rawDesc = "" +
	...
	"\x0eAidAttestation\x12-.spire.plugin.agent.nodeattestor.v1.Challenge\x1a>.spire.plugin.agent.nodeattestor.v1.PayloadOrChallengeResponse(\x010\x01B^Z\\github.com/accuknox/spire-plugin-sdk/proto/spire/plugin/agent/nodeattestor/v1;nodeattestorv1b\x06proto3"
