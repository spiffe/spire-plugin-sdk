...
var (
	...
	file_spire_plugin_types_x509certificate_proto_rawDescData = file_spire_plugin_types_x509certificate_proto_rawDesc
)
...
func file_spire_plugin_types_x509certificate_proto_rawDescGZIP() []byte {
	file_spire_plugin_types_x509certificate_proto_rawDescOnce.Do(func() {
		file_spire_plugin_types_x509certificate_proto_rawDescData = protoimpl.X.CompressGZIP(file_spire_plugin_types_x509certificate_proto_rawDescData)
	})
...
var file_spire_plugin_types_x509certificate_proto_goTypes = []interface{}{
...
func file_spire_plugin_types_x509certificate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_spire_plugin_types_x509certificate_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_spire_plugin_types_x509certificate_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_spire_plugin_types_x509certificate_proto_rawDesc = nil
