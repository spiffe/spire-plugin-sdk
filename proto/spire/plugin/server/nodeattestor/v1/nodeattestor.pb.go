...
const file_spire_plugin_server_nodeattestor_v1_nodeattestor_proto_rawDesc = "" +
	...
	"\fNodeAttestor\x12u\n" +
	"\x06Attest\x122.spire.plugin.server.nodeattestor.v1.AttestRequest\x1a3.spire.plugin.server.nodeattestor.v1.AttestResponse(\x010\x01B_Z]github.com/accuknox/spire-plugin-sdk/proto/spire/plugin/server/nodeattestor/v1;nodeattestorv1b\x06proto3"
