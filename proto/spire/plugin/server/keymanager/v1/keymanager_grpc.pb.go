...
const (
	KeyManager_GenerateKey_FullMethodName   = "/spire.plugin.server.keymanager.v1.KeyManager/GenerateKey"
	KeyManager_GetPublicKey_FullMethodName  = "/spire.plugin.server.keymanager.v1.KeyManager/GetPublicKey"
	KeyManager_GetPublicKeys_FullMethodName = "/spire.plugin.server.keymanager.v1.KeyManager/GetPublicKeys"
	KeyManager_SignData_FullMethodName      = "/spire.plugin.server.keymanager.v1.KeyManager/SignData"
)
...
func (UnimplementedKeyManagerServer) SignData(context.Context, *SignDataRequest) (*SignDataResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SignData not implemented")
}
