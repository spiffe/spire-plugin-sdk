...
const file_spire_plugin_server_keymanager_v1_keymanager_proto_rawDesc = "" +
	"\n" +
	...
	"\bSignData\x122.spire.plugin.server.keymanager.v1.SignDataRequest\x1a3.spire.plugin.server.keymanager.v1.SignDataResponseB[ZYgithub.com/accuknox/spire-plugin-sdk/proto/spire/plugin/server/keymanager/v1;keymanagerv1b\x06proto3"

var (
	file_spire_plugin_server_keymanager_v1_keymanager_proto_rawDescOnce sync.Once
	file_spire_plugin_server_keymanager_v1_keymanager_proto_rawDescData []byte
)
...
func file_spire_plugin_server_keymanager_v1_keymanager_proto_rawDescGZIP() []byte {
	file_spire_plugin_server_keymanager_v1_keymanager_proto_rawDescOnce.Do(func() {
		file_spire_plugin_server_keymanager_v1_keymanager_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spire_plugin_server_keymanager_v1_keymanager_proto_rawDesc), len(file_spire_plugin_server_keymanager_v1_keymanager_proto_rawDesc)))
	})
...
var file_spire_plugin_server_keymanager_v1_keymanager_proto_goTypes = []any{
...
func file_spire_plugin_server_keymanager_v1_keymanager_proto_init() {
	...
	file_spire_plugin_server_keymanager_v1_keymanager_proto_msgTypes[7].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spire_plugin_server_keymanager_v1_keymanager_proto_rawDesc), len(file_spire_plugin_server_keymanager_v1_keymanager_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
