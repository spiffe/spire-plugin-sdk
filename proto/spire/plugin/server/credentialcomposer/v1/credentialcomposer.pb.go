...
type JWTSVIDAttributes struct {
	...
	//
	// https://github.com/accuknox/spiffe/blob/main/standards/JWT-SVID.md
	//
...
const file_spire_plugin_server_credentialcomposer_v1_credentialcomposer_proto_rawDesc = "" +
	...
	"\x16ComposeWorkloadJWTSVID\x12H.spire.plugin.server.credentialcomposer.v1.ComposeWorkloadJWTSVIDRequest\x1aI.spire.plugin.server.credentialcomposer.v1.ComposeWorkloadJWTSVIDResponseBkZigithub.com/accuknox/spire-plugin-sdk/proto/spire/plugin/server/credentialcomposer/v1;credentialcomposerv1b\x06proto3"
