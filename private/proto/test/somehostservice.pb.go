...
const file_test_somehostservice_proto_rawDesc = "" +
	"\n" +
	"\x1atest/somehostservice.proto\x12\x04test\x1a\x0ftest/echo.proto2K\n" +
	"\x0fSomeHostService\x128\n" +
	"\x0fHostServiceEcho\x12\x11.test.EchoRequest\x1a\x12.test.EchoResponseB9Z7github.com/accuknox/spire-plugin-sdk/private/proto/testb\x06proto3"

var file_test_somehostservice_proto_goTypes = []any{
...
func file_test_somehostservice_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_test_somehostservice_proto_rawDesc), len(file_test_somehostservice_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
