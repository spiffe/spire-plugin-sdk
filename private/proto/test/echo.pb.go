...
var file_test_echo_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x74, 0x65, 0x73, 0x74, 0x2f, 0x65, 0x63, 0x68, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x04, 0x74, 0x65, 0x73, 0x74, 0x22, 0x1d, 0x0a, 0x0b, 0x45, 0x63, 0x68, 0x6f, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x02, 0x69, 0x6e, 0x22, 0x20, 0x0a, 0x0c, 0x45, 0x63, 0x68, 0x6f, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x6f, 0x75, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x6f, 0x75, 0x74, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68,
	...
	0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x74, 0x65, 0x73,
	0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_test_echo_proto_rawDescOnce sync.Once
	file_test_echo_proto_rawDescData = file_test_echo_proto_rawDesc
)

func file_test_echo_proto_rawDescGZIP() []byte {
	file_test_echo_proto_rawDescOnce.Do(func() {
		file_test_echo_proto_rawDescData = protoimpl.X.CompressGZIP(file_test_echo_proto_rawDescData)
	})
	return file_test_echo_proto_rawDescData
}

var file_test_echo_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_test_echo_proto_goTypes = []interface{}{
...
func file_test_echo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_test_echo_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_test_echo_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_test_echo_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_test_echo_proto_rawDesc = nil
